...
![](../assets/001_image_IZzfbK38Ao.D0N9ZTVW.png)

比如加载腾讯会议连接器，

![](../assets/002_image_WF3ab0WSbo.DphxGEGY.png)

![](../assets/003_image_ZssEbuMsdo.Dhg8VjKq.png)

## 创建一个任务 ​

帮我创建一个明天下午 3 点的会议，

![](../assets/004_image_KVIJbpUZdo.BRYRrqpV.png)

主题“项目讨论”，时长1h

![](../assets/005_image_FPy1bGJJZo.CH9_F62R.png)

创建成功

![](../assets/006_image_WQ6Zb1Rero.JBzT8KRW.png)

## 新建连接器 ​

连接器管理页右上角点“自定义连接器”，按引导配置 MCP（含服务地址、鉴权方式），并提示自定义连接器的访问范围由用户配置

![](../assets/007_image_M2itbQUceo.DA3g1zrW.png)