...
![](/assets/001_image_TdcLblfvIo.JAXghKd8.png)

也可以在SkillHub技能市场里找到合适的Skill

![](/assets/002_image_V3E5bsVZGo.CNcIiHwr.png)

除了从推荐列表里直接安装，还可以**导入自己下载的技能**。

比如你在网上看到一个好用的技能包，下载下来是一个 zip 压缩文件，操作流程是这样的：点击"上传技能"，把 zip 文件加载即可

![](/assets/003_image_Oag3bNQHOo.b-8ptr40.png)

![](/assets/004_image_GgOebNBh3o.CPUvV_oi.png)

## 使用Skill解决一个任务 ​

比如，你让AI写了一篇文章，需要去除AI味，你可以找到“文章去AI味工具 ”Skill，安装之后，使用时，直接 “/” 可以换出。

![](/assets/005_20260708200848_NN3hbPsKAo.B8peHH8Y.gif)

你只需要引用Skill内容，把文章给到即可，

![](/assets/006_image_Xom2btXVZo.Cxu6iZ-s.png)

WorkBuddy 会先加载skill的内容，

![](/assets/007_image_AmOVb1oGEo.D502lg6P.png)

根据skill中的规则，来执行，比如要去除不是而是、双引号等内容，

![](/assets/008_image_FbpQbmSswo.nrN9jN1J.png)

修改之后，可以得到结果，确实去除了AI味。

![](/assets/009_image_RhBKbRhgIo.BFK_niy2.png)

## Skill的关闭和卸载 ​

从全部技能中，点击我安装的

![](/assets/010_image_NGsdbBcjso.CTQ38jHp.png)

按钮关闭（则关闭该Skill）

![](/assets/011_image_DABBb41fGo.IjaR-w9T.png)

点击“···”，可以选择删除或编辑该Skill

![](/assets/012_image_Uya3bNC9io.7Wlm0KE8.png)